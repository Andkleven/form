...
const operatorQC = async (geometry, unique=false) => {
  ...
  await write("12/05/2222 2108", textBox("Start Time"));
  await write("12/05/2222 2108", textBox("Stop Time"));
  ...
  await write("12/05/2222 2108", textBox("Touch Up Performed"));
...
//       await waitFor(3000)
//       await checkBox("Media Blasting").uncheck();
//       await waitFor(500)
//       await click("Submit")
//       await waitFor(3000)
//       await click("Back")
