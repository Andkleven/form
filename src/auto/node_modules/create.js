...
const {select, writeSelect} = require("general")
...
export const description = async (geometry) => {
...
export const leadEngineer = async (geometry) => {
  ...
  await write("73165 3mm", "Compound Number");
